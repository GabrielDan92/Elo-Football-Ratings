...
if __name__ == "__main__":
    ...
    Champions_League    = ExtractMatches(comp="Champions-League", start_year=2017, confidence=0.58, misc_league=True)
    Europa_League       = ExtractMatches(comp="Europa-League", start_year=2017, confidence=0.58, misc_league=True)
    Europa_Conf_League  = ExtractMatches(comp="Europa-Conf-League", start_year=2021, confidence=0.57, misc_league=True)

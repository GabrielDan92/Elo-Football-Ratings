...
FIRST_MATCH = 30
MIN_CORRECT_GAMES = 50
SIM_START_YR = 2018
SIM_END_YR = datetime.date.today().year + 1
DEFAULT_START_YEAR = 2018
DEFAULT_CONFIDENCE = 0.6

MAP = {
    "BRAZIL Serie B": {"suffix": "Serie-B-Scores-and-Fixtures", "comp_id": 38, "custom_link": True},
    ...
    "NETHERL Eredivisie League": {"suffix": "Eredivisie-Scores-and-Fixtures", "comp_id": 23},
...
leagues = (
    {"comp": "BRAZIL Serie B", "start_year": 2020, "confidence": 0.6},
    {"comp": "SPAIN La Liga 2", "start_year": 2020, "confidence": 0.6},
    ...
    {"comp": "NETHERL Eredivisie League", "start_year": 2020, "confidence": 0.57},  # 73%
